...
class Cell:
    ...
    def __init__(self: 'Cell', location: typing.Tuple[int, int]) -> 'Cell':
        Cell.create_sprites()
    ...
    def create_sprites():
        ...
        # global Conf.scale
        Cell.scale = Conf.scale
        print("creating sprites", "Conf.scale", Conf.scale, "Cell.sprite_scale", Cell.scale)
    ...
    def calc_position(self):
        self.position = (self.location[0] * 16 * Cell.scale + Conf.play_area.left, self.location[1] * 16 * Cell.scale + Conf.play_area.top)
